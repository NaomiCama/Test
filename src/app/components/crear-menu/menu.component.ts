...
import { FormGroup, FormControl, Validators } from '@angular/forms'; // Asegúrate de importar Validators
...
export class MenuComponent implements OnInit {
  ...
  menus: Menu[] = []; // Inicializa como un array vacío
  pagedMenus: Menu[] = []; // Inicializa como un array vacío
  ...
  ngOnInit(): void {
    ...
    console.log('menus:', this.menus); // Verifica si menus está definido
  }
  ...
  guardarEdicion(): void {
    ...
    this.nuevoMenu.nombrem = formValue.nombre;
